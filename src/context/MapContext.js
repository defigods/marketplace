...
export class MapProvider extends Component {
  constructor(props) {
    ...
    this.enableMultipleLandSelection = this.enableMultipleLandSelection.bind(
      this
    )
    this.disableMultipleLandSelection = this.disableMultipleLandSelection.bind(
      this
    )
    this.changeMultipleLandSelectionList = this.changeMultipleLandSelectionList.bind(
      this
    )
    this.resetMultipleLandSelectionList = this.resetMultipleLandSelectionList.bind(
      this
    )
    ...
    this.changeActiveBuyOfferOverlay = this.changeActiveBuyOfferOverlay.bind(
      this
    )
      ...
      <MapContext.Provider
        value={{
          ...
          actions: {
            ...
            changeMultipleLandSelectionList: this
