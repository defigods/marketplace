	...
	const renderSubTabVesting = () => {
		if(subTab == 'ovrg'){
			return (
				...
				<div className="o-row o-flow-root">
					<div className="o-row">
						<h3 className="c-section-title">Claim OVR</h3>
					</div>
					<div className="o-row o-flow-root">
				...
				<div className="o-row o-flow-root">
					...
					<div className="o-half">
						<HexButton
							...
							className={`--orange --large --kyc-button --only-butt`}
							// ${bidValid ? '' : '--disabled'}
							onClick={() => AllowanceStaking('ovrg15')}
						></HexButton>
					</div>
					<div className="o-half">
						<HexButton
				...
				<div className="o-row o-flow-root">
					...
					<div className="o-half">
						<HexButton
							...
							className={`--orange --large --kyc-button --only-butt`}
							// ${bidValid ? '' : '--disabled'}
							onClick={() => AllowanceStaking('ovrg30')}
						></HexButton>
					</div>
					<div className="o-half">
						<HexButton
