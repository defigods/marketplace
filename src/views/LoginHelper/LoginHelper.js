...
const LoginHelper = () => {
  ...
  function metamaskComponent() {
    ...
    if (isWeb3Active) {
      ...
      web3NetworkVersion =
        parseInt(web3context.state.chainId, 16) === config.web3network
    }
        ...
        <div className="o-container">
          <div className="o-box">
            ...
            <div className="Signup__section --left">
              {isWeb3Active ? (
                <div className="o-list">
                  <CheckCircleSharpIcon className="CheckCircleSharpIcon" />{' '}
                  {t('Signup.web3.install')}
                </div>
              ) : (
                <div className="o-list">
              ...
              {web3NetworkVersion ? (
                <div className="o-list">
                  <CheckCircleSharpIcon className="CheckCircleSharpIcon" />{' '}
                  {t('Signup.connect.to')}{' '}
                  {String(config.web3network) === '4' ? 'Rinkeby' : 'Mainnet'}{' '}
                  {t('Signup.network')}
                </div>
              ) : (
                <div className="o-list">
            ...
            {isWeb3Active && web3NetworkVersion && isWeb3Account ? (
              <>
                <div className="Signup__section Signup__msg --positive">
                  {t('Signup.web3.present')}
                </div>
              </>
            ) : (
              <>
