...
const HexImage = ({ className, src, style }) => (
	<svg className={className} height="102" width="102" viewBox="0 0 102 102" style={style}>
		<defs>
			...
			<pattern id="background-image" patternUnits="userSpaceOnUse" width="100" height="100">
				<image xlinkHref={src} x="0" y="0" width="100" height="100" preserveAspectRatio="xMinYMin slice" />
			</pattern>
		</defs>
		<polyline
